...
// };
// use crate::token::dcql_vp_token::DcqlQueryVpToken;
// use dcql_oid4vc_core::client_metadata::ClientMetadataResource;
// use dcql_oid4vc_core::dcql_openid4vc_extension::{OpenID4VC, RequestHandle, ResponseHandle};
// use dcql_oid4vc_core::SubjectSyntaxType;
// use dcql_oid4vc_core::{authorization_response::AuthorizationResponse, dcql_openid4vc_extension::Extension};
...
//     type Input = DcqlQueryVpToken;
//     type Parameters = AuthorizationResponseParameters;
//     type ResponseItem = DcqlQueryVpToken;
// }
