...
|                 | Support for `jwt_vs_json` credential format                                      |     ✅      |
|                 | Support for `jwt_vs_json-ld` credential format                                   |     ❌      |
|                 | Support for `ldp_vc` credential format                                           |     ❌      |
|                 | Support for `mso_mdoc` credential format                                         |     ❌      |
|                 | Support for `dc+sd-jwt` credential format                                        |     ❌      |
