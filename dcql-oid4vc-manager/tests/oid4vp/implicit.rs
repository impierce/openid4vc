// use dcql_oid4vc_core::authentication::subject::Subject;
...
//     jwt,
// };
// use dcql_oid4vc_manager::{methods::key_method::KeySubject, ProviderManager, RelyingPartyManager};
// use dcql_oid4vp::{
//     dcql::dcql_query::{CredentialId, DcqlQuery},
//     token::dcql_vp_token::PresentationFormat,
//     token::dcql_vp_token_builder::DcqlVpTokenBuilder,
// };
...
// use oid4vp::{
//     authorization_request::ClientMetadataParameters, oid4vp::OID4VP, ClaimFormatDesignation, ClaimFormatProperty,
// };
// use serde_json::json;
...
//     let dcql_vp_token = DcqlVpTokenBuilder::builder_dcql_query(DCQL_QUERY.clone())
//         .add_presentation(
//             CredentialId::from("my_credential".to_string()),
...
//         .generate_response(&authorization_request, dcql_vp_token)
//         .await
//         .unwrap();
